...
<div><tbody>
<div style="padding:20px;font-size:15px;min-height:100px;"><?php echo htmlspecialchars($archive_info[0]['content']);?></div>
...
<dd><?php echo htmlspecialchars($v['content']);?></dd>
</dl>
<?php }?>
...
<div class="blank10"></div>
<?php $editor->Width=960;$editor->Height=300;$editor->Create();?>
<div class="blank10"></div>
...
<div class="blank30"></div>
 ...
 <script>
  ...
  $("#submit").click(function(){
     var content = escape(getContent('content'));
