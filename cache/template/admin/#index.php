...
<!-- 调用样式表 -->
<link href="<?php echo $skin_path;?>/admin.css" rel="stylesheet" type="text/css" />
...
<div class="box">
<div id="header">
<a href=""><img src="<?php echo $skin_path;?>/images/logo.png" class="logo" /></a>
<div class="top_right">
<ul>
...
<li><a href="http://www.cmseasy.cn" target="_blank">官方网站</a> | <a href="http://www.cmseasy.cn/service_1.html" target="_blank">授权</a> | <a href="http://www.cmseasy.org" target="_blank">支持论坛</a> | <a href="http://chm.cmseasy.cn/" target="_blank">帮助？</a></li>
</ul>
</div>
</div>
...
?>
<li class="<?php echo $class;?>"><a href="<?php echo $m;?>"><?php echo $n;?></a></li>
<?php } ?>
</ul>
...
<?php if(hasflash()) { ?>
<div id='message'><div id='message_bg'><img src="<?php echo $skin_path;?>/images/ico_11.gif" />&nbsp;<?php echo showflash(); ?>
...
<!--用于PNG图片在IE6下透明-->
<!--[if IE 6]>
<script type="text/javascript" language="javascript" src="<?php echo $base_url;?>/js/png.js"></script>
<script>
