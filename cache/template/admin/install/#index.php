...
<div id="main">
<div id="logo" style="background:url(<?php echo $skin_path;?>/install/login_logo.png) no-repeat left top !important; /*For Firefox*/*background:none;/*For IE7 & IE6*/_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='<?php echo $skin_path;?>/install/login_logo.png',sizingMethod='crop');/*For IE6*/display: block;"><a href="http://www.cmseasy.org" target="_blank">论坛</a>	| <a href="http://www.cmseasy.org/forum-10-1.html" target="_blank">报错</a> | <a href="http://www.cmseasy.org/forum-9-1.html" target="_blank">在线教程</a></div>
...
<tr>
 ...
 <td>PHP版本</td> <td>5.0以上</td> <td>5.2以上</td> <td><?php echo PHP_VERSION; ?></td> <td align="center"><?php echo helper::yes(PHP_VERSION>=5.0); ?></td>
  ...
  <tr>
 <td>MySQL版本</td> <td>5.1以上</td> <td>5.0以上</td> <td><?php echo @$mysql_verion;?></td> <td align="center">
 <?php if($pass) { ?>
