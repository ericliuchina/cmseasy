...
<script language="javascript" src="<?php echo $base_url;?>/common/js/jquery/ui/ui.datepicker.js"></script>
    ...
    <link href="<?php echo $base_url;?>/images/dialog.css" rel="stylesheet" type="text/css" />
...
<span class="hotspot" onmouseover="tooltip.show('选择内容所在栏目，如果栏目有子级栏目，请选择子级栏目！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
</tr>
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('typeid',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('选择内容所在分类，如果分类有子级分类，请选择子级分类！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
        <td width="149" align="right">置顶</td>
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('toppost',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('文章置顶,可按栏目或全站置顶！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
        <td width="149" align="right">标题</td>
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('title',$form,$field,$data,'class="input"');?>
<span class="hotspot" onmouseover="tooltip.show('填写内容标题！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
<input id="color" name="color" value="#000000"/>  <input name="strong" type="checkbox" value="1" <?php if($data['strong']==1) { ?>checked<?php } ?> /></td>
    </tr>
    <tr>
...
<div class="blank30"></div>
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('introduce',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('填写内容简介，如留空将自动截取内容中字符作为简介！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
        <td width="149" align="right">Tag标签</td>
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('tag',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('选择内容所属Tag标签！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
        <td width="149" align="right"></td>
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td><input type="text" name="adddate" id="adddate" value="<?php echo date('Y-m-d H:i:s'); ?>" class="skey" /><span class="hotspot" onmouseover="tooltip.show('内容发布时间，可自定义，格式：2010-08-08 08:08:08！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
<tr>
...
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
</span>
        </td>
    </tr>
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td><input type="text" name="author" id="author" value="<?php echo $user['username'] ?>"   class="skey" /><span class="hotspot" onmouseover="tooltip.show('内容发布作者名，可自定义！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
        <td width="149" align="right">来源</td>
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('attr3',$form,$field,$data);?><span class="hotspot" onmouseover="tooltip.show('内容发布来源，可自定义，默认为本站网址！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:5px; margin-right:5px;"></span>
</td>
    </tr>
<tr>
        <td width="149" align="right">审核</td>
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('checked',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('设置内容是否发布，勾选未审核，不在前台显示，内容在后台列表可继续编辑！<br />默认：为审核状态！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
</table>
      </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="table2">
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('mtitle',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('可填写不同于内容名称的关键词，有利于搜索优化！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
        <td width="149" align="right">关键词</td>
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('keyword',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('网页META信息中的keywords信息，可填写与内容相关的关键词，以英文逗号相隔，有利于搜索优化！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
        <td width="149" align="right">页面描述</td>
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('description',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('网页META信息中的description信息，可填写与内容相关的简介，有利于搜索优化！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td>
<input name="htmlrule1" type="text" class="input" value="<?php echo $data['htmlrule'];?>" /><span class="hotspot" onmouseover="tooltip.show('你可以自定生成文件名称<br /><br />例如：abc.html<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>{</b>$caturl<b>}</b>/abc.html<br />默认：<b>{</b>$caturl<b>}</b>/show_<b>{</b>$aid<b>}</b>(_<b>{</b>$page<b>}</b>).html<br /><b>{</b>$caturl<b>}</b> = 栏目目录<br /><b>{</b>$aid<b>}</b> = 内容ID<br /><b>{</b>$page<b>}</b> = 内容分页值！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
<div class="blank10"></div>
<font color=gray>如有分页，请一定要在自定义名称后加入分页函数_<b>{</b>$page<b>}</b>！</font>
        <div class="blank30"></div>
        <?php echo form::getform('htmlrule',$form,$field,$data);?>
<span class="hotspot" onmouseover="tooltip.show('你可以选择系统默认的URL规则<br />例如：abc.html<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>{</b>$caturl<b>}</b>/abc.html<br />默认：<b>{</b>$caturl<b>}</b>/show_<b>{</b>$aid<b>}</b>(_<b>{</b>$page<b>}</b>).html<br /><b>{</b>$caturl<b>}</b> = 栏目目录<br /><b>{</b>$aid<b>}</b> = 内容ID<br /><b>{</b>$page<b>}</b> = 内容分页值！');" onmouseout="tooltip.hide();"><img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
</td>
    </tr>
    <tr>
        <td width="149" align="right">生成HTML</td>
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('ishtml',$form,$field,$data);?>
...
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
    ...
    <div class="blank10"></div>
<a title="选择文件" onclick="javascript:windowsdig('选择文件','iframe:index.php?case=file&act=updialog&fileinputid=pics&getbyid=pvpics&maxselect=99&checkfrom=piclistshow','900px','480px','iframe')" href="#body"><p><img src="images/add_pic.gif" /></p></a><span class="hotspot" onmouseover="tooltip.show('当内容页模板选择：<br /> [ 图片内容页 - archive/show_pic.html ] <br />用于图片幻灯显示效果展示！');" onmouseout="tooltip.hide();">
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
</span>
            </div>
        </td>
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td id="content-recommend"><?php echo form::getform('attr1',$form,$field,$data);?>
...
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('linkto',$form,$field,$data);?>
...
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
    ...
    <tr>
        ...
        <td>
            <table width="90%">
<tr>
<td width="20%"><?php echo form::getform('grade',$form,$field,$data);?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="table4">
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('thumb',$form,$field,$data);?>
...
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
    ...
    <tr>
        ...
        <td>
            ...
            附件路径：<input type="text" name="attachment_path" class="input"  id="attachment_path" value="<?php echo $data['attachment_path'];?>" /><span class="hotspot" onmouseover="tooltip.show('填写此项无须再上传附件，请填写完整的url地址，例如：http://www.cmseasy.cn/upload/attachment.rar！');" onmouseout="tooltip.hide();">
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
</span>
<div class="blank10"></div>

            <input type="hidden" name="attachment_id"  id="attachment_id" value="<?php echo archive_attachment(@$data['aid'],'id');?>"  class="input" />
            附件名称：<input type="text" name="attachment_intro"  id="attachment_intro" value="<?php echo archive_attachment(@$data['aid'],'intro');?>" class="input" />
...
<div class="blank10"></div>
            ...
            <span style="float:left;">保存地址：<span id="attachment_path_i"><?php echo archive_attachment(@$data['aid'],'path');?></span></span><input style="float:left;" type="button" name="delbutton"  class="a_del" onclick="attachment_delect(get('attachment_id').value)" />
<div class="blank10"></div>
...
<input type="button"  name="filebuttonUpload"  id="filebuttonUpload" onclick="return ajaxFileUpload('fileupload','<?php echo url("tool/uploadfile",false);?>','#uploading');" value="上传" class="btn_d" />
...
图片url
        ...
        <td width="1%">&nbsp;</td>
        <td>
<?php echo form::input("vote[$i]",vote::title(@$data['aid'],$i),'class="input" ');?>
<span class="hotspot" onmouseover="tooltip.show('填写内容中投票内容名称！');" onmouseout="tooltip.hide();">
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
</span>
<div class="blank5"></div>
<?php echo form::input("vote_image[$i]",vote::img(@$data['aid'],$i),'class="input" ');?>
...
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
    ...
    <tr>
        <td width="149" align="right">产品价格</td>
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('attr2',$form,$field,$data);?>
...
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td><?php echo form::getform('pcolor',$form,$field,$data);?>
...
<div class="blank30"></div>
<img src="<?php echo $skin_path;?>/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"> &nbsp;注意：勾选为该用户组禁止浏览或下载
