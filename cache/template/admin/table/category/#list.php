...
<td align="center" ><span class="hotspot" onmouseover="tooltip.show('填写排序号，<br />数字越小，排序越靠前！');" onmouseout="tooltip.hide();"><?php echo form::input("listorder[$d[$primary_key]]",$d['listorder'],'class="input_c"');?></span></td>
<td align="center" >
<?php echo $d['catid'];?>
</td>
