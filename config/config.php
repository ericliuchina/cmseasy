...
//后台登录IP验证开关[<span class="hotspot" onmouseover="tooltip.show('打开或者关闭IP验证功能');" onmouseout="tooltip.hide();"><img src="./images/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>]=>0/关/1/开
...
'slide_pic1_title'=>'CmsEasy3.0助力企业网络营销',
...
'slide_pic2_url'=>'http://www.cmseasy.cn', 
...
'slide_pic3_title'=>'免费下载CmsEasy,还有机会获取商业授权',
...
'slide_pic3_url'=>'http://www.cmseasy.cn',
...
'slide_pic4_title'=>'欢迎网建公司及工作室参与CmsEasy官方分享计划', //图片4标题[<span class="hotspot" onmouseover="tooltip.show('填写幻灯中的标题！');" onmouseout="tooltip.hide();"><img src="./images/remind.gif" alt="" width="14" height="20" style="margin-left:10px; margin-right:5px; /"></span>]
