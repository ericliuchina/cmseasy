    ...
    static function allmenu() {
        return $menu=array(
                ...
                '网站设置'=>array(
                        ...
                        '内容推荐'=>url::create('table/setting/table/archive'),
                ...
                '标签列表'=>array(
                        '函数标签'=>url::create('table/list/table/templatetag/tagfrom/function'),
                        '系统标签'=>url::create('table/list/table/templatetag/tagfrom/system'),
                ...
                '模板管理'=>array(
                        '模板选择'=>url::create('config/system/set/template'),
                        '模板结构'=>url::create('template/note'),
                        '当前模板编辑'=>url::create('template/edit'),
                ),
                '自定义表单'=>array(
