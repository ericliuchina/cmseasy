...
<span class="hotspot" onmouseover="tooltip.show('选择内容所在栏目，如果栏目有子级栏目，请选择子级栏目！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
    ...
    <tr>
		...
		<span class="hotspot" onmouseover="tooltip.show('填写内容标题！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></span>
		<input id="color" name="color" value="#000000"/>  <input name="strong" type="checkbox" value="1" {if $data['strong']==1}checked{/if} /></td>
    </tr>
    <tr>
