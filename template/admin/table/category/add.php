...
<td width="1%">&nbsp;</td>
<td>{form::getform('parentid',$form,$field,$data)}
...
<tr>
<td colspan="3" align="right"><table width="100%" align="center" cellpadding="0" cellspacing="0">
  <tbody id="single" style="display:block;">
    <tr>
      <th width="149" height="25" align="right">栏目名称</th>
      <td width="30">&nbsp;</td>
      <td><input type="text" class="input" name="catname" id="catname" size="30"/></td>
    </tr>
    <tr>
      <th height="25" align="right">目录名称</th>
      <td>&nbsp;</td>
      <td><input type="text" class="input" name="htmldir" id="htmldir" size="30"/></td>
    </tr>
  </tbody>
  <tbody id="batch" style="display:none;">
    <tr>
      ...
      <td><table cellspacing="0" cellpadding="0">
        <tr>
          <td width="214"><textarea name="batch_add" maxlength="255"></textarea></td>
