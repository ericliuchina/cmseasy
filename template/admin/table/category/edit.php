...
<span class="hotspot" onmouseover="tooltip.show('填写网站栏目名称！');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>
...
<td width="1%">&nbsp;</td>
<td>
{form::getform('htmldir',$form,$field,$data,'123 class="input"')}<span class="hotspot" onmouseover="tooltip.show('目录必须是英文名，留空则自动使用拼音名');" onmouseout="tooltip.hide();"><img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;"></td>
</tr>
